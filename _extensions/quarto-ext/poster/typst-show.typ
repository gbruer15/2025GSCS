...
#show: doc => poster(
  ...
  $if(header-left-content)$ header_left_content: [$header-left-content$], $endif$
  $if(footer-left-content)$ footer_left_content: [$footer-left-content$], $endif$
  $if(footer-center-content)$ footer_center_content: [$footer-center-content$], $endif$
  $if(footer-right-content)$ footer_right_content: [$footer-right-content$], $endif$
  ...
  $if(departments-font-size)$ departments_font_size: $departments-font-size$, $endif$
